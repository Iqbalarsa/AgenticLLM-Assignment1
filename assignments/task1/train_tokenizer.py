...
parser.add_argument('--max-chars', type=int, default=500_000_000, help='Maximum characters to train on (default: 500MB)')
parser.add_argument('--doc-cap', type=int, default=10_000, help='Maximum characters per document (default: 10,000)')
parser.add_argument('--vocab-size', type=int, default=32768, help='Vocabulary size (default: 32768 = 2^15)')
parser.add_argument('--output-dir', type=str, default="tokenizer", help='Subdirectory name under base_dir to save the tokenizer')
